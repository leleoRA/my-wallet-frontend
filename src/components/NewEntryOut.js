...
export default function NewEntryIn() {
    ...
    function submitEntry(e) {
        ...
        if(entryValue === "" || entryDescription === "") {
            ...
            const request = axios.post(`http://localhost:4000/new-entry-out/${user.userId}`, body);
            ...
            request.catch((error)=> {
                setIsLoading(false);
                alert('Houve um erro ao postar sua saída.');
            });
        }
    }
    ...
    return(
        <Body>
            ...
            <Form onSubmit={submitEntry}>
                ...
                <Button isloading={isLoading} disabled={isLoading} type="submit">Salvar saída</Button>
            </Form>
        </Body>
    )
}
